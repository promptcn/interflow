...
use interflow_testkit::{
    agent_config, echo_server, hub_config, pick_ephemeral_port, spawn_agent, spawn_hub,
    wait_for_tcp,
};
...
fn metrics_handle() -> &'static PrometheusHandle {
    METRICS.get_or_init(|| {
        ...
        // First installation; ignore if already installed (impossible —
        // OnceLock guarantees single execution)
